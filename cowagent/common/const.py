...
CLAUDE_35_SONNET = (
    "claude-3-5-sonnet-latest"  # 带 latest 标签的模型名称，会不断更新指向最新发布的模型
)
CLAUDE_35_SONNET_1022 = (
    "claude-3-5-sonnet-20241022"  # 带具体日期的模型名称，会固定为该日期发布的模型
)
...
GEMINI_31_FLASH_LITE_PRE = (
    "gemini-3.1-flash-lite-preview"  # Gemini 3.1 Flash Lite Preview - Agent推荐模型
)
