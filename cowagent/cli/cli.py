...
from cowagent.cli.commands.skill import skill
from cowagent.cli.commands.process import start, stop, restart, update, status, logs
from cowagent.cli.commands.context import context
from cowagent.cli.commands.install import install_browser
...
@click.group(
    cls=CowCLI, invoke_without_command=True, context_settings=dict(help_option_names=[])
)
@click.pass_context
def main(ctx):
    """CowAgent CLI - Manage your CowAgent instance."""
