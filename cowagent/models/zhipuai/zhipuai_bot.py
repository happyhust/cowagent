...
from cowagent.models.zhipuai.zhipu_ai_session import ZhipuAISession
from cowagent.models.zhipuai.zhipu_ai_image import ZhipuAIImage
    ...
    def reply_text(self, session: ZhipuAISession, args=None, retry_count=0) -> dict:
        ...
        try:
            ...
            if "rate" in error_str and "limit" in error_str:
                ...
                "error" in error_str or "gateway" in error_str
            ):
        ...
        try:
            ...
            request_params = {
                ...
                "temperature": kwargs.get(
                    "temperature", self.args.get("temperature", 0.9)
                ),
