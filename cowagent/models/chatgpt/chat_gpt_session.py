from cowagent.models.session_manager import Session
...
def num_tokens_from_messages(messages, model):
    ...
    if model in [
        ...
        const.GPT4_VISION_PREVIEW,
        const.GPT4_TURBO_01_25,
        const.GPT_4o,
        const.GPT_4O_0806,
        const.GPT_4o_MINI,
        const.LINKAI_4o,
        const.LINKAI_4_TURBO,
        const.GPT_5,
        const.GPT_5_MINI,
        const.GPT_5_NANO,
    ]:
    ...
    if model == "gpt-3.5-turbo":
        ...
        logger.debug(
            f"num_tokens_from_messages() is not implemented for model {model}. Returning num tokens assuming gpt-3.5-turbo."
        )
        return num_tokens_from_messages(messages, model="gpt-3.5-turbo")
    num_tokens = 0
